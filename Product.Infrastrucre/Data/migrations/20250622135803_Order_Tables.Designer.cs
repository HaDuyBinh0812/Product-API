...
namespace Product.Infrastrucre.Data.migrations
{
    ...
    [Migration("20250622135803_Order_Tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product.Core.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Product.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Product.Core.Entities.Address", b =>
                {
                    b.HasOne("Product.Core.Entities.AppUser", "AppUsers")
                        .WithOne("Address")
